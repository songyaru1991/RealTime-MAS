var idTmr;
    ...
    var tableToExcel = (function () {
        ...
        return function (table, name) {
            ...
            var tableValue = table.innerHTML;
            /*tableValue.replace("<td>","<td style=\"mso-number-format:\'\@\';\" ng-bind=\"data.paySerialNo\">");
            console.log(tableValue);*/
            var ctx = {worksheet: name || 'Worksheet', table: tableValue};

		...
		<div class="panel-body"
			...
			<div class="col-sm-12 col-sm-12" style="margin-left: -15px">
				...
				<form id="form1" enctype="multipart/form-data">
					...
					</span>&nbsp; 此次共導入：<span id="sumCostid">0</span>個費用代碼
					...
					<input type="checkbox" name="overTime15min" value="0">上刷超15分鐘<!-- checked="checked" -->
					<input type="checkbox" name="overTime15min" value="1">下刷超15分鐘

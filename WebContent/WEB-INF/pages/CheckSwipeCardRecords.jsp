...
<c:url value="/resources/js/Project/QuerySwipeCard.js?version=${resourceVersion}" var="QuerySwipeCardJS"></c:url>
...
<script src="${QuerySwipeCardJS }" type="text/javascript"></script> 
			...
			<div class="col-sm-12 col-sm-12" style="margin-left: -15px">
				...
				<form id="form1" enctype="multipart/form-data">
					...
					結束日期: <input id="dpick2" class="Wdate" type="text" name="TimeEnd"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',minDate:'#F{$dp.$D(\'dpick1\')}'})" autocomplete="off" /> <br>
					<br> <input type="button" class="btn btn-primary" id="submit"
						...
						value="導出" onclick="javascript:Save1('上下班刷卡記錄')"/>&nbsp; <input type="button" class="btn btn-primary"
						value="清空" id="clearTable" />&nbsp; <br>
					此次共查詢出：<span id="sumData">0</span>條數據
					<div id="swipeCardInfoPagination" align="right"
